...
# commented all references to breadcrumbs
# commented includes for Hyrax::ThemedLayoutController
# commented reference to themed_layout
# commented dependency 'bulkrax/application_controller'
...
#       NoMethodError (undefined method `add_breadcrumb' for #<Bulkrax::ImportersController:0x0000ffff900f8d28>
# acda_portal | Did you mean?  add_importer_breadcrumbs)'
      # add_breadcrumb t(:'hyrax.controls.home'), main_app.root_path
      # add_breadcrumb t(:'hyrax.dashboard.breadcrumbs.admin'), hyrax.dashboard_path
      # add_breadcrumb 'Importers', bulkrax.importers_path
      true
